        ...
        return html`
            <div class="container">
                ...
                <div class="setting-group">
                    ...
                    <div class="setting-item indent ${!this.mediaPlayerEnabled || !this.padsEnabled ? 'disabled' : ''}">
                        <div style="flex: 1;">
                            ...
                            >
                                ${this.padSets && this.padSets.length ? this.padSets.map(set => html`
                            ...
                            ${this.padSetError ? html`<div class="padset-message" style="color: #ffb3b3;">${this.padSetError}</div>` : ''}
                        </div>
                    </div>
                </div>
