...
import { listPadSets, uploadPadSet, derivePadSetName, getActivePadSet, selectPadSet } from '../js/pad-set-service.js';
...
export class PadSetManager extends LitElement {
    ...
    renderPadSetList() {
        ...
        return this.padSets.map(set => html`
                ...
                <label class="padset-header">
                    ...
                    <div>
                        ...
                        <div class="padset-meta">
                            ...
                            ${set.modifiedTime ? html` • Updated ${new Date(set.modifiedTime).toLocaleString()}` : ''}
                        </div>
                    </div>
                </label>
            </div>
    ...
    render() {
        return html`
            ...
            <form @submit=${this._handleUpload}>
                ...
                ${this.successMessage ? html`<div class="status-message success">${this.successMessage}</div>` : ''}
