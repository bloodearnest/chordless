...
export class AppModal extends LitElement {
    ...
    _renderActions() {
        ...
        if (this.type === 'confirm') {
            return html`
                <div class="modal-actions" part="actions">
                    <button class="modal-btn modal-btn-cancel" part="cancel-button" @click=${this._handleCancel}>
                        ${this.cancelLabel}
                    </button>
                    <button class="modal-btn modal-btn-confirm" part="confirm-button" @click=${this._handleConfirm}>
                        ${this.confirmLabel}
                    </button>
                </div>
            `;
