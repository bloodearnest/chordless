...
import { getCurrentOrganisation, setCurrentOrganisation, listOrganisations } from '../js/workspace.js';
        ...
        return html`
            <div class="organisation-selector">
                <div class="organisations-list">
                    ${this._organisations.map(org => html`
                        <div
                        ...
                        >
                            ...
                            ${org === this._currentOrganisation
                                ...
                                : html`<button class="switch-button" @click=${(e) => {
                                    e.stopPropagation();
                ...
                ${this._showCreateForm ? html`
                    <form class="create-form" @submit=${this._handleCreate}>
                        ...
                        <div class="create-form-buttons">
                            <button type="button" class="cancel" @click=${this._toggleCreateForm} ?disabled=${this._creating}>
                                Cancel
                            </button>
