...
export class SetlistInfo extends LitElement {
    ...
    renderTitle() {
        ...
        const titleText = this.setlist.name
            ? `${formattedDate} - ${this.setlist.name}`
            : formattedDate;
    ...
    renderInfoGrid() {
        ...
        return html`
            <div class="modal-info-grid">
                ...
                ${this.setlist.createdAt ? this.renderInfoItem('Created', this.formatDateTime(this.setlist.createdAt)) : ''}
                ${this.setlist.updatedAt ? this.renderInfoItem('Last Modified', this.formatDateTime(this.setlist.updatedAt)) : ''}
            </div>
        `;
    }
