...
export class ShareSetlist extends LitElement {
            ...
            this._shareLink
              ? html`
                ...
                <div class="button-group">
                  <button class="setlist-button" @click=${this._copyLink}>📋 Copy Link</button>
          ...
          this._isAuthenticated
            ? html`
              <div class="share-method">
                ...
                <p>
                  Share via Google Drive to enable real-time collaboration and live performance
                  sync.
                </p>
  ...
  async _generateShareLink() {
    ...
    try {
      ...
      // Fire event
      this.dispatchEvent(
        new CustomEvent('share-complete', {
          bubbles: true,
          composed: true,
